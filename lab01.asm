...
main:   # Words ending with ':' are **labels**
        ...
        lw        $a1, matric                                                                    #''gets the value of matric into $a1 and holds it"
        ...
        lw $v0,0( $a0)                      # integer returned in $v0
        ...
        lw           $a2, 0($s0)                                                        #''loads the value of s0 into s1
...
###############################################################################
        ...
        #  
matric: .word 2432    # This will be used by your submitted code
